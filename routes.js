...
router.get('/newstyle', (req, res) => {
  ...
  router.get('/updateData/:group', (req, res) => {
      let gameId = req.params.group;
  ...
  router.post('/game', function(req, res) {
    ...
    router.post('/saveScore/:sumTotal/:who/:game', (req, res) => {
